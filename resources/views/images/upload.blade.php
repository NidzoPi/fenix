...
<script>
	...
	Dropzone.options.myDropzone = {
		...
		handleSuccess: function(response){
			...
			$('#fuckimgs').append(' <div class="col-sm-4 pt-5 pl-2"> <img src="'+ imageSrc +'" width="300"> <form class="pl-5 pt-2" name="delete-image" action="'+ deleteSrc +'" method="DELETE"> {{ csrf_field() }}  <input type="submit" value="Obriši" class="btn btn-danger btn-sm"> </form></div> ');
		}
	};
	</script>
